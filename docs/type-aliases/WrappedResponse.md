...
> **WrappedResponse**\<`T`\> = \{ `error?`: `undefined`; `result`: `T`; `status_code`: `200`; \} \| \{ `error?`: `undefined`; `result?`: `undefined`; `status_code`: `204`; \} \| \{ `error`: `string`; `result?`: `undefined`; `status_code`: `400` \| `403` \| `424` \| `500`; \}
...
\{ `error?`: `undefined`; `result?`: `undefined`; `status_code`: `204`; \}
