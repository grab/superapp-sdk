 ...
 * const splash = new SplashScreenBridgeModule();
 * ```
 *
 * @example
 * **CDN (UMD):**
 ...
 * <script>
 *   const splash = new SuperAppSDK.SplashScreenBridgeModule();
 * </script>
 * ```
 *
 * @public
 * @noInheritDoc
 */
export class SplashScreenBridgeModule extends BaseModule {
  constructor() {
    super('SplashScreenBridgeModule');
  }
   ...
   * @example
   * ```typescript
   * import { SplashScreenBridgeModule, isSuccess, isErrorResponse } from '@grabjs/superapp-sdk';
   *
