...
/** Valibot schema for {@link GetCoordinateResult}. @public */
export const GetCoordinateResultSchema = v.object({ lat: v.number(), lng: v.number() });

/** Valibot schema for {@link GetCoordinateResponse}. @public */
...
/** Valibot schema for {@link GetCountryCodeResult}. @public */
export const GetCountryCodeResultSchema = v.object({ countryCode: v.string() });

/** Valibot schema for {@link GetCountryCodeResponse}. @public */
