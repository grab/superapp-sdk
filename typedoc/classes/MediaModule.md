...
> **observePlayDRMContent**(`data`: `any`): [`DataStream`](../type-aliases/DataStream.md)\<`unknown`\>
...
[`DataStream`](../type-aliases/DataStream.md)\<`unknown`\>

***

### playDRMContent()

> **playDRMContent**(`data`: `any`): `Promise`\<[`BridgeResponse`](../type-aliases/BridgeResponse.md)\<`unknown`\>\>
